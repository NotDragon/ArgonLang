...
std::string ArgonLang::primitive_type_to_string(PrimitiveType type) {
	switch (type) {
	case INT8:
		return "i8";
	case INT16:
...
ArgonLang::PrimitiveType ArgonLang::determine_integer_type(const std::string& value) {
...
std::string ArgonLang::ast_node_type_to_string(ASTNodeType type) {
	...
	case ASTNodeType::NullExpression:
	...
	case ASTNodeType::MultipleIndexExpression:
		return "MultipleIndexExpression";
	...
	case ASTNodeType::GenericParameter:
...
ArgonLang::ASTNodeGroup ArgonLang::ExpressionNode::get_node_group() const {
	return ArgonLang::ASTNodeGroup::Expression;
}

ArgonLang::ASTNodeGroup ArgonLang::StatementNode::get_node_group() const {
	return ArgonLang::ASTNodeGroup::Statement;
}

ArgonLang::ASTNodeGroup ArgonLang::TypeNode::get_node_group() const {
