...
namespace Runtime {
    ...
    template std::vector<int> accumulate(std::vector<int>&& container, std::function<std::vector<int>(std::vector<int>, int)>&& reducer);
    template std::vector<int> accumulate(const std::vector<int>& container, std::function<std::vector<int>(std::vector<int>, int)>&& reducer);
