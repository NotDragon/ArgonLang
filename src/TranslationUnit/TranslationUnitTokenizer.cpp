		...
		if (c == '`') {
			...
			while (i < length && input[i] != '`') {
				if (input[i] == '\\') {
					i++;
					if (i >= length)
						throw std::runtime_error("Unterminated escape sequence in literal" +
			...
			if (i >= length) {
				throw std::runtime_error("Unterminated literal" + std::to_string(currentLine) + ", column " +
				                         std::to_string(currentColumn));
			}
			i++;
...
std::string ArgonLang::TranslationUnit::Token::getTypeAsString(Token::Type type) {
	...
	case Token::Identifier:
		return "Identifier";
	case Token::UnitToken:
		return "UnitToken";

	case Token::UnitBinaryExpression:
		return "UnitBinaryExpression";
	case Token::UnitAdditiveBinaryExpression:
		return "UnitAdditiveBinaryExpression";
	case Token::UnitMultiplicativeBinaryExpression:
		return "UnitMultiplicativeBinaryExpression";
	case Token::UnitLogicalOrBinaryExpression:
		return "UnitLogicalOrBinaryExpression";
	case Token::UnitLogicalAndBinaryExpression:
		return "UnitLogicalAndBinaryExpression";
	case Token::UnitEqualityBinaryExpression:
		return "UnitEqualityBinaryExpression";
	case Token::UnitRelationalBinaryExpression:
		return "UnitRelationalBinaryExpression";
	case Token::UnitBitwiseBinaryExpression:
		return "UnitBitwiseBinaryExpression";
	case Token::UnitAssignmentBinaryExpression:
		return "UnitAssignmentBinaryExpression";

	case Token::UnitUnaryExpression:
		return "UnitUnaryExpression";
	case Token::UnitParallelUnaryExpression:
		return "UnitParallelUnaryExpression";
	case Token::UnitDerefUnaryExpression:
		return "UnitDerefUnaryExpression";
	case Token::UnitReferenceUnaryExpression:
		return "UnitReferenceUnaryExpression";
	case Token::UnitIncrementUnaryExpression:
		return "UnitIncrementUnaryExpression";
	case Token::UnitDecrementUnaryExpression:
		return "UnitDecrementUnaryExpression";
	case Token::UnitPlusUnaryExpression:
		return "UnitPlusUnaryExpression";
	case Token::UnitMinusUnaryExpression:
		return "UnitMinusUnaryExpression";
	case Token::UnitLogicalNotUnaryExpression:
		return "UnitLogicalNotUnaryExpression";
	case Token::UnitBitwiseNotUnaryExpression:
		return "UnitBitwiseNotUnaryExpression";

	case Token::UnitStructExpression:
		return "UnitStructExpression";
	case Token::UnitMatchExpression:
		return "UnitMatchExpression";
	case Token::UnitToExpression:
		return "UnitToExpression";
	case Token::UnitFilterExpression:
		return "UnitFilterExpression";
	case Token::UnitMapExpression:
		return "UnitMapExpression";
	case Token::UnitReduceExpression:
		return "UnitReduceExpression";
	case Token::UnitFunctionCallExpression:
		return "UnitFunctionCallExpression";
	case Token::UnitRangeExpression:
		return "UnitRangeExpression";
	case Token::UnitIndexExpression:
		return "UnitIndexExpression";
	case Token::UnitMemberAccessExpression:
		return "UnitMemberAccessExpression";

	case Token::UnitVariableDeclaration:
		return "UnitVariableDeclaration";
	case Token::UnitFunctionDeclaration:
		return "UnitFunctionDeclaration";
	case Token::UnitIfStatement:
		return "UnitIfStatement";
	case Token::UnitForStatement:
		return "UnitForStatement";
	case Token::UnitWhileStatement:
		return "UnitWhileStatement";
	case Token::UnitReturnStatement:
		return "UnitReturnStatement";
	case Token::UnitBreakStatement:
		return "UnitBreakStatement";
	case Token::UnitContinueStatement:
		return "UnitContinueStatement";
	case Token::UnitTypeAlias:
		return "UnitTypeAlias";
	case Token::UnitClassDeclaration:
		return "UnitClassDeclaration";
	case Token::UnitBlock:
		return "UnitBlock";
	case Token::UnitImplStatement:
		return "UnitImplStatement";
	case Token::UnitYieldStatement:
		return "UnitYieldStatement";
	case Token::UnitConstructorStatement:
		return "UnitConstructorStatement";

	case Token::UnitType:
		return "UnitType";
	case Token::UnitIdentifierType:
		return "UnitIdentifierType";
	case Token::UnitGenericType:
		return "UnitGenericType";
	case Token::UnitSumType:
		return "UnitSumType";
	case Token::UnitIntersectionType:
		return "UnitIntersectionType";
	case Token::UnitPrefixedType:
		return "UnitPrefixedType";

	case Token::UnitImport:
		return "UnitImport";
